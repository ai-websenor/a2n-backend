...
export class RegisterDto {
  ...
  @ApiProperty({
    description:
      'Password with minimum 8 characters, must contain uppercase, lowercase, number and special character',
  ...
  @ApiProperty({
    description:
      'Unique account name with only lowercase letters, numbers, and hyphens',
  ...
  @Matches(/^[a-z0-9-]+$/, {
    message:
      'Account name must contain only lowercase letters, numbers, and hyphens',
  })
  accountName: string;
}
